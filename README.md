...
in a lot of the different accessibility services I work on.  This repo contains (or will contain) utilities for
Accessibility Node Infos (/compat), Accessibility Services, and other Android API related classes.  

Eventually this library will also provide the "recommended" spoken string, so that Accessibility services that aim
